...
(function ($) {
    ...
    if ($("body").not(".is-mobile").hasClass("tp-magic-cursor")) {
        ...
        if( ball?.dataset ){
            let small_color = ball.dataset.smallCursor;
            let big_color = ball.dataset.bigCursor;
            let text_color = ball.dataset.textColor;
            $("[data-cursor]").each(function () {
                $(this).on("mouseenter", function () {
                    $("#ball").addClass("with-blur");
                    $ball.append(`<div class="ball-view" style="color: ${text_color}"></div>`);
                    ...
                    gsap.to($ball, {
                        ...
                        backgroundColor: big_color,
                    });
                    gsap.to(".ball-view", { duration: 0.3, scale: 1, autoAlpha: 1 });
                }).on("mouseleave", function () {
                    gsap.to($ball, { duration: 0.3, yPercent: -50, width: $ballWidth, height: $ballHeight, opacity: $ballOpacity, borderWidth: $ballBorderWidth, backgroundColor: small_color });
