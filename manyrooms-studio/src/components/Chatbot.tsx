    ...
    <>
      ...
      <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 md:bottom-8 md:right-8 z-[100]">
        <button
          ...
          className="group relative bg-primary text-white p-3 sm:p-4 rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-105 active:scale-95"
        >
          {isOpen ? (
          ...
          <div className="absolute bottom-full right-0 mb-2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none hidden sm:block">
            <div className="bg-brand-dark text-white text-[10px] font-bold uppercase tracking-widest px-3 py-1.5 rounded shadow-2xl whitespace-nowrap">
              Chat with Aria
            </div>
          </div>
        </button>
      ...
      {isOpen && (
        <>
          ...
          <div className={`
            fixed z-[100] bg-white flex flex-col overflow-hidden border border-gray-200 shadow-2xl
            /* Mobile: full screen */
            inset-0 m-0 rounded-none
            /* Tablet: smaller, centered */
            sm:inset-auto sm:bottom-24 sm:right-6 sm:w-[450px] sm:h-[600px] sm:rounded-2xl
            /* Desktop: original size */
            md:bottom-24 md:right-8 md:w-[420px] md:h-[550px] md:rounded-2xl
          `}>
            {/* Header */}
            <div className="bg-primary text-white p-4 flex-shrink-0">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-base sm:text-lg">Aria</h3>
                    <p className="text-[10px] sm:text-xs opacity-80">Many Rooms Concierge</p>
                  </div>
                </div>
                <button
                  onClick={() => setIsOpen(false)}
                  className="p-1 hover:bg-white/10 rounded-lg transition-colors sm:hidden"
                >
            ...
            <div className="flex-1 overflow-y-auto p-3 sm:p-4 space-y-3 sm:space-y-4 bg-gray-50">
              {messages.map((message) => (
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-[8px] sm:text-[10px] opacity-50 mt-1">
              ...
              {isTyping && (
                <div className="flex justify-start">
                  <div className="bg-white border border-gray-200 rounded-2xl rounded-bl-sm px-3 py-2 sm:px-4 sm:py-2">
            ...
            {/* Suggested Queries - Hide on mobile after scrolling */}
            {messages.length < 3 && (
                ...
                <div className="flex flex-wrap gap-2">
                  {suggestedQueries.map((query) => (
                    <button
                      ...
                      className="text-[10px] sm:text-xs bg-gray-100 hover:bg-gray-200 text-gray-700 px-2 py-1 sm:px-3 sm:py-1.5 rounded-full transition-colors"
                    >
                      {query}
                    </button>
                  ))}
            ...
            <div className="p-3 sm:p-4 border-t border-gray-100 bg-white flex-shrink-0">
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 border border-gray-200 rounded-full px-3 py-2 sm:px-4 sm:py-2 text-xs sm:text-sm focus:outline-none focus:border-primary"
                />
                <button
